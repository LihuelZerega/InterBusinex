  ...
  return (
    <div className="h-[80vh] lg:h-[100vh] xl:h-[100vh] w-full border-b border-ui-border-base relative bg-ui-bg-subtle bg-white">
      <div className="h-full w-full object-cover absolute inset-0">
        <Image src={HeroMobile} alt="" width={1080} height={1920} className="block lg:hidden h-full w-full object-cover absolute inset-0 rounded-b-2xl"/>
        <Image src={HeroImage} alt="" width={1920} height={1040} className="hidden lg:block h-full w-full object-cover absolute inset-0 rounded-b-2xl"/>
      </div>
